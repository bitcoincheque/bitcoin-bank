 ...
 * Description.
 */
class Admin_Income_Statement_View extends Admin_Std_View {
    ...
    public function create_content( $parameters = null ) {
        ...
        $grid->add_rows($parameters['income_headers']);
        $grid->add_rows($parameters['income_accounts']);
        $grid->add_rows($parameters['income_sum']);

        $grid->add_row(array('','',''));

        $grid->add_rows($parameters['expense_header']);
        $grid->add_rows($parameters['expense_accounts']);
        $grid->add_rows($parameters['expense_sum']);

        $grid->add_row(array('','',''));

        $grid->add_rows($parameters['profit']);
