...
class Operation_Cheque_Payment_View extends Admin_Std_View {
    ...
    public function __construct( $id, $controller )
    {
        ...
        $this->email = new Text_Line();
        $this->amount = new Text_Line();
        $this->memo = new Text_Line();
        $this->button_make_transfer = new Push_Button( esc_html__( 'Send Cheque', 'bitcoin-bank' ));
    ...
    public function create_content( $parameters = null ) {
        ...
        $grid->add_row();
        $grid->add_cell_header( new Label( 'Send to e-mail:', array( 'for' => 'email' )) );
        $grid->add_cell( $this->email );
