...
class Operation_Withdraw_Cash_View extends Admin_Std_View {
    ...
    public function __construct( $id, $controller )
    {
        $items = array(
            ...
            'equity_withdrawal' => 'Equity withdrawal',
            'dividend_withdrawal' => 'Dividend withdrawal',
        );
        $this->transfer_type = new Drop_Down_List($items, 'client_withdrawal');
    ...
    public function create_content( $parameters = null ) {
        ...
        $grid->add_row();
        $grid->add_cell_header( new Label( 'From client account:', array( 'for' => 'from_account' )) );
        $grid->add_cell( $this->from_account );

        $grid->add_row();
        $grid->add_cell_header( new Label( 'Cash vault:', array( 'for' => 'to_account' )) );
