 ...
 * Description.
 */
class Operation_Add_Cash_Controller extends Admin_Controller
{
    ...
    {
        $model_class = null;
        $view_class = 'BCQ_BitcoinBank\Operation_Add_Cash_View';
    ...
    public function button_transfer_type_reload_cheque_click()
    {
        ...
        switch($transfer_type) {
            case 'client_deposit':
                $from_account = Accounting::get_sub_account_chart_list(Account_Chart_Db_Table::SUB_TYPE_BALANCE_ASSET_CASH_HOT_VAULT);
                $to_account = Accounting::get_sub_account_chart_list(Account_Chart_Db_Table::SUB_TYPE_BALANCE_LIABILITIES_CLIENT_SAVINGS);
                break;

            case 'add_equity':
                $from_account = Accounting::get_sub_account_chart_list(Account_Chart_Db_Table::SUB_TYPE_BALANCE_ASSET_CASH_HOT_VAULT);
                $to_account = Accounting::get_sub_account_chart_list(Account_Chart_Db_Table::SUB_TYPE_BALANCE_EQUITY_PAID_IN_CAPITAL);
                break;
