 ...
 * Description.
 */
class Operation_Payment_Request_Controller extends Admin_Controller
{
    ...
    {
        $model_class = null;
        $view_class = 'BCQ_BitcoinBank\Operation_Payment_Request_View';
    ...
    public function button_transfer_type_reload_cheque_click()
    {
        ...
        switch($transfer_type) {
            case 'expense':
                ...
                $to_account = Accounting::get_main_account_chart_list(Account_Chart_Db_Table::MAIN_TYPE_BALANCE_LIABILITIES);
                break;
