 ...
 * Description.
 */
class Cheque_Received_List_Controller extends List_Controller
{
    ...
    protected function load_model_values( $values = array() )
    {
        if ( isset( $this->model ) )
        {
            ...
            $this->model->load_data(Cheque_Db_Table::RECEIVER_CLIENT_ID, $client_id);

            $columns = array(
                Cheque_Db_Table::PRIMARY_KEY,
                Cheque_Db_Table::ISSUE_TIMESTAMP,
                Cheque_Db_Table::STATE,
                Cheque_Db_Table::SENDER_ADDRESS,
